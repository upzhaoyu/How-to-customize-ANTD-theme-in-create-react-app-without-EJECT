# How to customize antd theme in create-react-app without ejecting
...
## Now you can customize as you wish by simply change (modifyVars: { '@primary-color': '#ff0000' },) this line in your config-overrides.js. After all of above just restart your project to see the result, enjoy!!!!!!!!!!!
```
@import "../color/colors";
